...
public class GroupHelper {
	...
	public static void useLuckPerms(LuckPermsHook luckPermsHook, DiscordSRVHHook discordSRVHHook, EssentialsXDiscordHook essentialsXDiscordHook, FileConfiguration config, Player p) {
	...
	public static void useVault(VaultHook vaultHook, DiscordSRVHHook discordSRVHHook, EssentialsXDiscordHook essentialsXDiscordHook, FileConfiguration config, Player p) {
